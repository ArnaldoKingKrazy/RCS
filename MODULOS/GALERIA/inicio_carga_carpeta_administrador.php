...
<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6 text-center mt-2">
  <div class="card sombra fondo-degradado-carpeta" title="<?php echo $carpeta; ?>"  align="center" style="width:150px; min-width: 150px; height: 150px;max-height: 150px;">
      <div class="card-body text-truncate ar-cursor-pointer" onclick="modulo_galeria_ver_carpeta('ver_carpeta<?php echo $carpeta;?>');">
            ...
            <div class="row">
              <div class="col-12">
                  <form enctype="multipart/form-data" onsubmit="modulo_galeria_eliminar_carpeta('elimina_carpeta<?php echo $carpeta;?>'); return false" id="elimina_carpeta<?php echo $carpeta;?>">
                    ...
                    <div class="d-grid">
                      <button type="submit"  form="elimina_carpeta<?php echo $carpeta;?>" class="btn btn-sm btn-danger sombra ancho100" ><i class="bi bi-trash mt-1 me-2 ms-2"></i></button>
                    </div>
                  </form>
              </div>
            </div>
