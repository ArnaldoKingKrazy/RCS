...
$id_usuario = $_SESSION["user_id"];
    ...
    if($action == 'ajax'){
        ...
        $query_a_buscar="SELECT count(*) AS numrows FROM siembra WHERE id_usuario_responsable='$id_usuario' ";
        if ($busqueda!="") {
...
<?php
    $query_a_ejecutar="SELECT * FROM siembra WHERE id_usuario_responsable='$id_usuario' ";
     if ($busqueda!="") {
...
<div class="card sombra " style="background: linear-gradient(rgba(255,255,255,0.70),rgba(255,255,255,0.70)),url(<?php echo $foto; ?>); background-size: cover;">
      ...
      <a class="no_link"href="#<?php echo $id_unico; ?> " data-bs-toggle="collapse" title="Click para Desplegar <?php echo $titulo; ?>">
    <div class="card-tittle text-center fondo_verdecito sombra pt-2 pb-2">

      
      <i class="fas fa-angle-down" style="float: left; margin-left: 10px; margin-top: 5px;"></i>
      <b> <?php echo $titulo; ?></b>
      <i class="fas fa-angle-down" style="float:right; margin-right: 10px; margin-top: 5px;"></i>
    ...
    <div class="row">
      ...
      <div class="col-4">
        ...
        <table width="100%" class="mt-3">
          <tr>
            <td>
            <a href="#" style="float: right;" class="btn btn-sm btn-primary sombra me-2" >Mas Información</a>
