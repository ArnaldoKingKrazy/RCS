...
$id_usuario = $_SESSION["user_id"];
    ...
    if($action == 'ajax'){
        ...
        $query_a_buscar="SELECT count(*) AS numrows FROM ordenes_de_trabajo WHERE estado='APROBADA' AND id_usuario_emisor='$id_usuario'  ";
        if ($busqueda!="") {
...
<?php
    $query_a_ejecutar="SELECT * FROM ordenes_de_trabajo WHERE estado='APROBADA'AND id_usuario_emisor='$id_usuario'  ";
     if ($busqueda!="") {
