...
<div class="card sombra " style="background: linear-gradient(rgba(255,255,255,0.70),rgba(255,255,255,0.70)),url(<?php echo $foto; ?>); background-size: cover;">
 ...
 <div class="card-tittle text-center fondo_verdecito sombra"><button class="btn btn-success btn-sm sombra" style="float: left;" onclick="crear_orden_de_trabajo('<?php echo $id_eliminar; ?>')">Crear Orden de trabajo</button><b> <?php echo $titulo; ?> </b></div>
