<script type="text/javascript">
  ...
  Array.prototype.slice.call(forms)
    ...
    <div class="col-12">
        <div class="row bg-dark alinear-centro centrar mt-1 ver-bordes sombra mx-auto">
          <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-1 mt-1  mx-auto ">
                ...
                <div class="input-group input-group-sm mx-auto" style="width: 250px;">
                  ...
                  <input type="text" name="busqueda" placeholder="Buscar Orden..." class="form-control form-control-sm" autocomplete="off" id="searchText">
              </div>
          </div>
          <div class="col-lg-5 col-md-5 col-sm-12 col-12 mb-1 mt-1 mx-auto ">
              <div id="pruebas_id"></div>
               <strong class="mx-auto text-white">Lista de Ordenes en espera de Aprobación</strong>
          </div>
        ...
        <div class="row  mt-3 carga_orden_busqueda "></div> 
...
$(document).on('keyup','#searchText',function(){
  ...
  function load(page,orden){
    ...
    var parametros = {"action":"ajax","page":page,"orden":orden};
    $.ajax({
      url:'AGRONOMO/ordenes_en_espera_carga.php',
      data: parametros,
      success:function(data){
        $(".carga_orden_busqueda").html(data);
      }
    })
  }
