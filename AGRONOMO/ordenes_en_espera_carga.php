...
$id_usuario = $_SESSION["user_id"];
    ...
    if($action == 'ajax'){
        ...
        $query_a_buscar="SELECT count(*) AS numrows FROM ordenes_de_trabajo WHERE estado='PENDIENTE' AND id_usuario_emisor='$id_usuario' ";
        if ($busqueda!="") {
...
<?php
    $query_a_ejecutar="SELECT * FROM ordenes_de_trabajo WHERE estado='PENDIENTE'AND id_usuario_emisor='$id_usuario' ";
     if ($busqueda!="") {
...
<div class="card">
    <div class="card-tittle text-center fondo_verdecito sombra pt-1 pb-1" style="border-radius: 5px 5px 0px 0px;">
       <i style="float: left;" class="text-secondary ms-1">En Espera...</i> <strong> <?php echo $asunto; ?> </strong>  <a href="#" class="btn btn-danger btn-sm me-1 sombra" style="float: right" onclick="eliminar_orden('<?php echo $id_orden; ?>')"><i class="bi bi-trash"></i></a>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card sombra mb-2">
                  <div class="card-tittle">
                    <span class="fondo_span sombra">Capataz Encargado:</span ><b> <?php echo _encargado_local($id_usuario_asignado);?></b>
                  </div>
                </div>
...
<div id="accordion">
  <div class="card">
      <a class="btn  fv_hover" data-bs-toggle="collapse" href="#collapseOne">
    <div class="card-tittle ">
  ...
  <div class="card">
     <a class="collapsed btn  fv_hover" data-bs-toggle="collapse" href="#collapseTwo">
    <div class="card-tittle ">
