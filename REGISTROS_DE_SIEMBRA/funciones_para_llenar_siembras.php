...
function _puntos($id_unico){
      include("../INCLUDES/CONEXION.php");
                       ...
                       $void=$void.'<div class="card sombra mb-3"><div class="card-tittle ms-3">Punto:<b class="ms-1 me-2" style="font-size: 11px;">'.$nombre_ubicacion.'</b> Lat: <b  style="font-size: 11px;" class="ms-1 me-2" id="latitud_dms'.$id_latitudes.'"></b> Long: <b  style="font-size: 11px;" class="ms-1 me-2" id="longitud_dms'.$id_latitudes.'"></b></div></div> ';
