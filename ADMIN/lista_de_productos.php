    ...
    <div class="col-12">
        ...
        <div class="row bg-dark alinear-centro centrar mt-1 ver-bordes sombra mx-auto">
          ...
          <div class="col-lg-5 col-md-5 col-sm-12 col-12 mb-1 mt-1  ">
            <button class="btn btn-success btn-sm sombra" style="float: right;" onclick="registro_producto_agricola();"><i class="bi bi-plus-circle "></i> Agregar</button>
...
$(document).on('keyup','#searchText',function(){
  ...
  function load(page,busqueda){
    ...
    var parametros = {"action":"ajax","page":page,"busqueda":busqueda};
        ...
        $.ajax({
          url:'ADMIN/productos_agricolas_carga.php',
          data: parametros,
