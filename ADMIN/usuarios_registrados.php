        ...
        <div class="row bg-dark alinear-centro centrar mt-1 ver-bordes sombra mx-auto">
          <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-1 mt-1  mx-auto ">
                <div class="input-group input-group-sm mx-auto" style="width: 250px;">
                  ...
                  <input type="text" name="busqueda" placeholder="Buscar Usuario..." class="form-control form-control-sm" autocomplete="off" id="searchText">
              </div>
          </div>
          <div class="col-lg-5 col-md-5 col-sm-12 col-12 mb-1 mt-1 mx-auto ">
              <div id="pruebas_id"></div>
               <strong class="mx-auto text-white">Lista de Usuarios Registrados</strong>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-12 col-12 mb-1 mt-1  ">
            <button class="btn btn-success btn-sm sombra" onclick="pag_registro();"><i class="bi bi-plus-circle "></i> Nuevo Usuario</button>
          </div>
        </div>

        <div class="row  mt-3 carga_registrados "></div> 
...
$(document).on('keyup','#searchText',function(){
  ...
  function load(page,usuario){
    ...
    $.ajax({
      url:'ADMIN/usuarios_registrados_carga.php',
      data: parametros,
      success:function(data){
        $(".carga_registrados").html(data);
      }
    })
  }
